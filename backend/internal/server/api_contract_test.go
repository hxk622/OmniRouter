...
import (
	...
	adminhandler "github.com/hxk622/OmniRouter/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "OmniRouter",
					...
					service.SettingKeySiteName:     "OmniRouter",
