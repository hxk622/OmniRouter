...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["omnirouter-admin", "jwt.<token>"].
	// - We always select "omnirouter-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"omnirouter-admin"},
}
