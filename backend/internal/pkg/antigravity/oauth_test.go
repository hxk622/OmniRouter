...
func setTestAntigravityClientID(t *testing.T, clientID string) {
	t.Helper()
	old := ClientID
	ClientID = clientID
...
func setTestAntigravityClientSecret(t *testing.T, clientSecret string) {
	t.Helper()
...
func TestGetClientSecret_环境变量设置(t *testing.T) {
	setTestAntigravityClientSecret(t, "")
...
func TestGetClientSecret_环境变量有前后空格(t *testing.T) {
	setTestAntigravityClientSecret(t, "  valid-secret  ")
...
func TestBuildAuthorizationURL_参数验证(t *testing.T) {
	setTestAntigravityClientID(t, testAntigravityClientID)
...
func TestConstants_值正确(t *testing.T) {
	setTestAntigravityClientID(t, testAntigravityClientID)
	setTestAntigravityClientSecret(t, testAntigravityClientSecret)
	...
	if secret != testAntigravityClientSecret {
