...
const (
	...
	// GeminiCLIOAuthClientIDEnv is the environment variable name for the built-in client_id.
...
var (
	// GeminiCLIOAuthClientID/Secret must be injected via environment or config.
