...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/omnirouter")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "omnirouter")
	...
	viper.SetDefault("database.dbname", "omnirouter")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "omnirouter:")
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/omnirouter")
