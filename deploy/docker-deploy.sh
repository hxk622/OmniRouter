#!/bin/bash
# =============================================================================
# OmniRouter Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for OmniRouter:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/hxk622/OmniRouter/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  OmniRouter Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    # Download .env.prod
    print_info "Downloading .env.prod..."
    if command_exists curl; then
        curl -sSL "${GITHUB_RAW_URL}/.env.prod" -o .env.prod
    else
        wget -q "${GITHUB_RAW_URL}/.env.prod" -O .env.prod
    fi
    print_success "Downloaded .env.prod"
    ...
    echo "  .env.prod                 - Production environment profile"
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose logs -f omnirouter"
    echo ""
